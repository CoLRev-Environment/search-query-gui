# Search Query – Web Interface

A lightweight **graphical web interface** for the [`search-query`](https://github.com/CoLRev-Environment/search-query) Python library.
...
- Web UI license: see `LICENSE` in this repository
- Core library license: https://github.com/CoLRev-Environment/search-query/blob/main/LICENSE